...
import com.itplus.foodrecipeapp.Adapter.RandomRecipeAdapter;
import com.itplus.foodrecipeapp.Listeners.RandomRecipeResponseListener;
...
//        dialog.show();
    ...
    private final RandomRecipeResponseListener randomRecipeResponseListener =
        ...
        public void didFetch(RandomRecipeApiResponse response, String message) {
            dialog.dismiss();
            rcvView = findViewById(R.id.rcvRandom);
            rcvView.setHasFixedSize(true);
            rcvView.setLayoutManager(new GridLayoutManager(MainActivity.this,1));
            randomRecipeAdapter = new RandomRecipeAdapter(MainActivity.this,response.recipes,recipeClickListener);
            rcvView.setAdapter(randomRecipeAdapter);
        }
